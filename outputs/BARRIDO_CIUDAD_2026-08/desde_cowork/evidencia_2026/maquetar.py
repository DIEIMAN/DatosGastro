...
<section class="tapa">
  ...
  <div class="tapa-pie">
    <p><strong>Cada cifra de este atlas lleva su fuente y su fecha, y cada cosa que todavía falta
    está declarada en el lugar donde falta.</strong> Relevamiento cerrado al 9 de agosto de 2026.</p>
  </div>
</section>
<div class="pb"></div>
<section class="portadilla">
  ...
  <table class="cifras">
   ...
   <tr><td class="n">39</td><td>polos gastronómicos, en catorce de las quince comunas</td></tr>
   <tr><td class="n">53</td><td>lugares estudiados con la misma regla, sin excepción para los que ya estaban</td></tr>
...
<section class="indice">
  ...
  <table class="idx">
   ...
   <tr><td class="r">—</td><td><strong>Qué sale de acá</strong></td></tr>
   <tr><td class="r">I</td><td>Presentación</td></tr>
   <tr><td class="r">II</td><td>Qué es un polo gastronómico</td></tr>
   <tr><td class="r">III</td><td>De dónde salen los datos</td></tr>
   <tr><td class="r">IV</td><td>Cómo se leyó el territorio</td></tr>
   <tr><td class="r">V</td><td>Los establecimientos con historia</td></tr>
   <tr><td class="r">VI</td><td>Las colectividades y sus calles</td></tr>
   <tr><td class="r">VII</td><td><strong>Los polos, uno por uno</strong> — los 39, con índice de barrios y quince mapas comunales</td></tr>
   <tr><td class="r">VIII</td><td>Los lugares que se midieron y no llegaron</td></tr>
   <tr><td class="r">IX</td><td>El alcance de este atlas</td></tr>
   <tr><td class="r">A</td><td>Anexo · La regla completa</td></tr>
   <tr><td class="r">B</td><td>Anexo · Las 124 concentraciones detectadas</td></tr>
   <tr><td class="r">C</td><td>Anexo · Glosario y fuentes</td></tr>
  </table>
