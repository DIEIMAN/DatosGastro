...
('R02','Avenida Corrientes','1 y 3','referencia publicada','A+B+E+F','PUBLICADO',F['corpus'],'cumple','cumple','cumple','polo admitido','Cuatro vias. ERR-18 aplicada al campo n_vias.','cerrado'),
...
('R04','Puerto Madero','1','referencia publicada','A+B+E+F','PUBLICADO',F['corpus'],'cumple','cumple','cumple','polo admitido','Cuatro vias. ERR-18 aplicada al campo n_vias.','cerrado'),
('R05','Belgrano','13','referencia publicada','A+B+C+D+E','PUBLICADO',F['corpus'],'cumple','cumple','cumple','polo admitido','Cinco vias. ERR-18 aplicada al campo n_vias.','cerrado'),
...
('R19','Federico Lacroze','15 y 13','referencia publicada','A+B+E+F','PUBLICADO · se amplia',F['corpus'],'cumple','cumple','cumple','polo admitido','Cuatro vias. ERR-18 aplicada al campo n_vias.','en revision'),
...
('Z37','Almagro','5','zona nueva','A+B+D+E+F','ENTRA',F['corpus']+' + ronda_13/via_C_almagro.csv','cumple','cumple','cumple','polo admitido','CINCO vias, no seis: la via C se cerro por medicion en ronda 13. ERR-18 aplicada al corpus.','por trazar'),
