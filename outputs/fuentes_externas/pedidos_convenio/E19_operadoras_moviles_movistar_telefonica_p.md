# Borrador de pedido de convenio — Operadoras móviles: Movistar/Telefónica, Personal/Telecom, Claro (E19)
...
Hola [Equipo de Operadoras móviles: Movistar/Telefónica, Personal/Telecom, Claro],
...
Nos interesaría evaluar una colaboración con Operadoras móviles: Movistar/Telefónica, Personal/Telecom, Claro para contar con indicadores **agregados y
...
- altas/bajas de comercios;
- plataforma/fuente;
- aclaración metodológica;

No buscamos:

- datos personales de usuarios o repartidores;
- tarjetas;
- CUIT/DNI nominal;
...
---
Contexto de la fuente (catálogo): Flujo peatonal agregado, visitantes únicos, origen/destino, permanencia por zonas, impacto de eventos y turismo.
Acceso real: Convenio comercial/institucional; datos anonimizados y agregados.
