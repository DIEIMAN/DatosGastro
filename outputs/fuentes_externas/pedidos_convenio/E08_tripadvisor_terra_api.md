# Borrador de pedido de convenio — Tripadvisor / Terra API (E08)
...
Hola [Equipo de Tripadvisor / Terra API],
...
Nos interesaría evaluar una colaboración con Tripadvisor / Terra API para contar con indicadores **agregados y
...
---
Contexto de la fuente (catálogo): Señal turística de restaurantes: presencia, rating/reviews y potencial de atractivo para visitantes.
Acceso real: Producto developer/comercial; legacy Content API tiene sunset anunciado y migración a Terra.
