# Borrador de pedido de convenio — Reservas online: Meitre, OpenTable, Resy, TheFork, plataformas locales (E15)
...
Hola [Equipo de Reservas online: Meitre, OpenTable, Resy, TheFork, plataformas locales],
...
Nos interesaría evaluar una colaboración con Reservas online: Meitre, OpenTable, Resy, TheFork, plataformas locales para contar con indicadores **agregados y
...
---
Contexto de la fuente (catálogo): Reservas, no-shows, ocupación, anticipación, horarios pico, tamaño de grupo.
Acceso real: Convenio/opt-in con plataforma o locales.
