# Borrador de pedido de convenio — Rappi (E09)
...
Nos interesaría evaluar una colaboración con Rappi para contar con indicadores **agregados y
...
---
Contexto de la fuente (catálogo): Locales activos en plataforma, pedidos, GMV, ticket promedio, tiempo de preparación, cancelaciones, disponibilidad, horarios, zonas de entrega, categorías/cocinas.
Acceso real: No encontré API pública institucional; los datos relevantes requieren convenio o exportación de merchant/partner dashboards.
