# Borrador de pedido de convenio — SUBE / transporte público agregado (E21)
...
Hola [Equipo de SUBE / transporte público agregado],
...
Nos interesaría evaluar una colaboración con SUBE / transporte público agregado para contar con indicadores **agregados y
...
---
Contexto de la fuente (catálogo): Flujos de pasajeros cercanos a zonas/eventos; sirve para contexto de demanda territorial.
Acceso real: Convenios interjurisdiccionales y/o datasets agregados existentes.
