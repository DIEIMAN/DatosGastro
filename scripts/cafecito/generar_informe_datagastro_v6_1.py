"""Genera la version final visual V6_1 del informe Cafecito DataGastro.
...
PDF_V6_1 = OUT_DIR / "INFORME_CAFECITO_DATAGASTRO_V6_1.pdf"
FINAL_PDF_V6_1 = FINAL_DIR / "INFORME_CAFECITO_DATAGASTRO_V6_1.pdf"
...
MAPA_COMUNAL = GRAF_DIR / "mapa_comunal_publico_v6_1.png"
MAPA_SEDES = GRAF_DIR / "mapa_sedes_cafeterias_v6_1.png"
MAPA_COMBINADO = GRAF_DIR / "mapa_cafeterias_y_publico_v6_1.png"
PLAN_BARRAS = GRAF_DIR / "tipo_plan_barras_v6_1.png"
...
def write_pdf(records: list[dict], stats: dict, ranking_rows: list[dict], sedes_comuna: list[dict]) -> int:
    ...
    with PdfPages(PDF_V6_1) as pdf:
        ...
        annex_page(pdf, 12)
    shutil.copy2(PDF_V6_1, FINAL_PDF_V6_1)
    return 12
...
def update_readme() -> None:
    ...
    block_v6_1 = """## Versión DataGastro V6_1 (final)
...
"""
    pattern_v6_1 = r"(?ms)^## Versión DataGastro V6_1 \(final\)\n.*?(?=^## |\Z)"
    if re.search(pattern_v6_1, text):
        text = re.sub(pattern_v6_1, block_v6_1.rstrip() + "\n\n", text)
    else:
        text = text.rstrip() + "\n\n" + block_v6_1
...
def main() -> None:
    ...
    print("=" * 72)
    print("Informe Cafecito DataGastro V6_1 (final)")
    ...
    print(f"  PDF: {PDF_V6_1}")
    print(f"  Copia final: {FINAL_PDF_V6_1}")
    print("=" * 72)
