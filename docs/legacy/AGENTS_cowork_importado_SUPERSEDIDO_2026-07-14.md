# [HISTORICO / SUPERSEDIDO] Instrucciones Cowork importadas — proyecto Gastronomía CABA

**Estado:** SUPERSEDIDO el 2026-07-14. No usar como instrucciones operativas.
**Origen:** sección "Imported Claude Cowork project instructions" de `AGENTS.md` (importada del
proyecto Claude Cowork inicial, previo al estado actual del repositorio).
**Motivo del archivo:** describía un arranque desde `gastronomia_caba_entregable_v1.zip`,
prioridades y estructura ya superadas, y empujaba a trabajar pipeline/dashboard/notebooks que hoy
requieren permiso explícito (conflicto con guardrails vigentes). Se conserva íntegra como
evidencia histórica del encargo original.
**Reemplazo vigente:** `AGENTS.md` + `CLAUDE.md` + `docs/skills_claude/` +
`docs/infraestructura_agentes_skills_v1_1/` (política V1.1 y ciclo operativo).
