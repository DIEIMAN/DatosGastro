...
El mapa global representa los 22 polos/ejes del universo semilla como areas,
...
- 32 puntos con `match_fuerte`.
- 27 puntos con `match_razonable_revisar_sede`.
- 25 puntos `zona_sucursal_a_revisar`, solo como referencia interna diferenciada.

No entran a mapas de puntos:

- 8 casos con vigencia no confirmada.
- 11 duplicados probables.
- 3 busquedas a corregir.
