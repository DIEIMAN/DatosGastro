# HANDOFF DOCUMENTAL → CARTÓGRAFO TERRITORIAL — V1
...
3. **Costanera Norte:** un único Polo Gastronómico Costanera Norte, cuatro componentes
   discontinuos, **incluido `CN_C02`**. Vacíos estructurales se preservan. Estatus
   editorial exploratorio (DEC-05/06) vigente.
...
- Matriz integrada: `MATRIZ_EVIDENCIA_DOCUMENTAL_INTEGRADA.csv` (53 filas: 42 evidencias
...
```text
docs/polos_gastro/evidencia_documental_integrada_v1/   (esta línea completa)
...
- Fusionar/eliminar un polo; promover Belgrano R; tercera subzona o promoción de
  Callao–9 de Julio en Recoleta; excluir `CN_C02` o fusionar componentes; publicar
  cifra de oferta para Recoleta; cambiar el estatus exploratorio de Costanera;
  nombrar núcleos de Belgrano (DH-05).
