# Evidencia documental integrada V1 — Belgrano, Recoleta, Costanera Norte

**Línea:** `docs/polos_gastro/evidencia_documental_integrada_v1/`
**Fecha:** 2026-07-11
...
- las decisiones humanas vigentes de Polos Gastro (DEC-01…DEC-09 y las decisiones
...
| `MATRIZ_EVIDENCIA_DOCUMENTAL_INTEGRADA.csv` | Matriz única: evidencia + inferencias + decisiones, con fuente_id y uso permitido |
| `BIBLIOGRAFIA_DOCUMENTAL_VERIFICADA.csv` | Fuentes deduplicadas con estado de acceso y carácter |
| `DECISIONES_Y_USOS_DOCUMENTALES.md` | Decisiones humanas vigentes y reglas de uso editorial |
| `CONTRADICCIONES_Y_VACIOS_DOCUMENTALES.md` | Contradicciones, correcciones y vacíos reales |
| `HANDOFF_DOCUMENTAL_CARTOGRAFO_V1.md` | Handoff operativo para cartógrafo territorial / Codex |
...
ESTA LÍNEA (V1)          →  integración; corrige y traza REC-R02; handoff al cartógrafo
```
...
5. `HANDOFF_DOCUMENTAL_CARTOGRAFO_V1.md` (lo único que necesita el cartógrafo para arrancar).
