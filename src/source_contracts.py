...
SOURCE_COLUMN_CONTRACTS = {
    "F01": {
        ...
        "direccion_original": ["direccion_original", "direccion", "domicilio", "calle", "ubicacion"],
    ...
    "F02": {
        ...
        "id_fuente": ["id_fuente", "fuente"],
        "anio": ["anio", "ano", "year"],
        "fecha_habilitacion": ["fecha_habilitacion", "fecha", "fecha_aprobacion", "fecha_inicio"],
        "rubro_original": ["rubro_original", "rubro", "actividad", "descripcion_rubro", "tipo_actividad"],
        "direccion_original": ["direccion_original", "direccion", "domicilio", "calle", "ubicacion"],
    ...
    "F03": {
        ...
        "direccion_original": ["direccion_original", "direccion", "domicilio", "ubicacion"],
        "barrio_original": ["barrio_original", "barrio"],
        "comuna_original": ["comuna_original", "comuna"],
